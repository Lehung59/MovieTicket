...
const getAllMovies = (query) => {
  return new Promise((resolve, reject) => {
    let sql = `select m.id, m.title, m.image as movies_image, m.synopsis, m.duration, m.release_date, m.duration, m.director, m.casts, m.synopsis, s.showdate, s.showtime 
